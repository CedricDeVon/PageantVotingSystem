...
namespace PageantVotingSystem.Source.Caches
{
    public class CacheData
    {
        ...
        public Type Get<Type>()
        {
            ...
            {
                throw new Exception($"'CacheData' type conversion failed");
            }
        }
        ...
        public CacheData Key(object key)
        {
            ...
            {
                throw new Exception($"'CacheData' is not a Dictionary nor is '{key}' an existing key");
            }
        }
        ...
        public CacheData Index(int index)
        {
            ...
            {
                throw new Exception($"'CacheData' is not a List nor is '{index}' a valid index");
            }
        }
