...
namespace PageantVotingSystem.Source.Utility
{
    public class Cryptography
    {
        ...
        {
            return EncryptCipher(GenerateHash(password), ConfigurationSettings.EnvironmentValue("StringBuffer"));
        }

        public static bool ValidatePassword(string hashText, string password)
        {
            return ValidateHash(DecryptCipher(hashText, ConfigurationSettings.EnvironmentValue("StringBuffer")), password);
        }
